...
export default function Reminder({renderFormRegister, renderFormLogin, setShowReminder}) {
  return (
    <div className='p-4 bg-purple-950 text-white'>
        ...
        <button className='bg-black text-sm p-1 ' onClick={setShowReminder}>x</button>
    </div>
  )
}
